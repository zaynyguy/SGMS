...
-- Indexes for faster lookup by activity, user, and status
CREATE INDEX idx_reports_activity_id ON "Reports" ("activityId");
...
-- Index for faster lookup by report
CREATE INDEX idx_attachments_report_id ON "Attachments" ("reportId");
