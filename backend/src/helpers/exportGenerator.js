...
function buildActivitiesWorkbook(rows) {
  ...
  buildSheet(workbook, "Activities", rows, [
    ...
    { header: "Q1 Record", key: "q1_record", width: 12 },
    { header: "Q2 Record", key: "q2_record", width: 12 },
    { header: "Q3 Record", key: "q3_record", width: 12 },
    { header: "Q4 Record", key: "q4_record", width: 12 },
    { header: "Progress", key: "progress", width: 12 },
    { header: "Weight", key: "weight", width: 10 },
