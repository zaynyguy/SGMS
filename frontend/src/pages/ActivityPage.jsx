...
const ActivityManager = () => {
  ...
  const loadActivities = async () => {
    ...
    try {
      ...
      setActivities(data);
      showToast('Activities loaded successfully!', 'read');
    } catch (err) {
  ...
  const handleCreateActivity = async (e) => {
    ...
    try {
      ...
      try {
        ...
        showToast('Invalid JSON format in metrics field', 'error');
        setIsLoading(false);
        return;
      }
      ...
      showToast(response.message || 'Activity created successfully!', 'create');
    } catch (err) {
  ...
  const handleUpdateActivity = async (e) => {
    ...
    try {
      ...
      showToast(response.message || 'Activity updated successfully!', 'update');
    } catch (err) {
  ...
  const handleDeleteActivity = async () => {
    ...
    try {
      ...
      showToast('Activity deleted successfully!', 'delete');
    } catch (err) {
