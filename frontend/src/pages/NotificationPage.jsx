      ...
      <div className="min-w-7xl mx-auto p-4 bg-gray-100 dark:bg-gray-900 transition-colors duration-300">
        ...
        <div className="mb-6">
          <div className="bg-[var(--surface-container-low)] dark:bg-gray-800 rounded-xl border border-[var(--outline-variant)] dark:border-gray-700 shadow-xl p-4">
            ...
            <div className="bg-[var(--surface-container-low)] dark:bg-gray-800 mt-4 p-4 rounded-lg border border-[var(--outline-variant)] dark:border-gray-700 shadow-inner">
          ...
          <div className="flex items-center justify-end">
            {unread > 0 && (
              <button
                ...
                className="px-4 py-2.5 rounded-full bg-[var(--primary)] dark:bg-indigo-700 hover:bg-[var(--primary-container)] dark:hover:bg-indigo-600 transition-all duration-200 text-[var(--on-primary)] dark:text-white font-medium shadow-[0_2px_6px_rgba(16,185,129,0.3)] dark:shadow-[0_2px_6px_rgba(16,185,129,0.4)] hover:shadow-[0_3px_8px_rgba(16,185,129,0.4)] dark:hover:shadow-[0_3px_8px_rgba(16,185,129,0.5)]"
                ...
                <div
                  ...
                  className={`flex items-start gap-4 p-5 transition-all duration-300 ${
                    n.isRead
                      ...
                      : "bg-[var(--primary-container)]/[0.15] dark:bg-gray-900/[0.3] hover:bg-[var(--primary-container)] dark:hover:bg-indigo-900/[0.5]"
                  } ${
                    animatingNotifications.has(n.id) 
                      ? "scale-[1.01] bg-green-200 dark:bg-purple-900/[0.3] shadow-[0_0_12px_rgba(125,82,96,0.2)] dark:shadow-[0_0_12px_rgba(125,82,96,0.3)]" 
