...
*
* MODIFIED: sanitizes "previousMetric" payload, just like "targetMetric".
*/
...
// MODIFIED: Added 'previousMetric' to this stringification logic
// targetMetric: if object, ensure stringified for endpoints that expect JSON string
["targetMetric", "previousMetric"].forEach((k) => {
if (Object.prototype.hasOwnProperty.call(p, k)) {
