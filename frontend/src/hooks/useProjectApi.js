...
// ----------------------------------------------------------------
// MODIFICATION START: Removed prefetching logic per user request
// ----------------------------------------------------------------

// (Removed goalIdsToPrefetch, asyncPool for loadTasks,
//  collectedTaskIds, and asyncPool for loadActivities)
...
[currentPage, pageSize] // Removed loadTasks, loadActivities, tasks from dependencies
);
